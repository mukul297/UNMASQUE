...
global_support_files_path = os.path.join(os.path.split(sys.argv[0])[0], "./support_files/")
global_reduced_data_path = os.path.join(os.path.abspath(os.path.dirname(__file__)), "/Users/mukulsharma/Desktop/unmasque-backup-july5/") #./reduced_data
